...
let hasResumeState = false // Add state tracking
...
document.getElementById("uploadBtn").addEventListener("click", async () => {
  ...
  hasResumeState = j.has_resume_state || false
  if (hasResumeState) {
    document.getElementById("resumeIndicator").classList.add("show")
  } else {
    document.getElementById("resumeIndicator").classList.remove("show")
  }

  document.getElementById("uploadMsg").innerText =
    "Detected " + detectedColumns.length + " columns after 'Folder Link'."
...
document.getElementById("startBtn").addEventListener("click", async () => {
  ...
  try {
    ...
    if (j.summary && j.summary["Merged PDFs location"]) {
      ...
      a.onclick = () => {
        alert("Merged PDFs saved server-side at: " + href)
      }
    }
...
// bind buttons
cancelMergeBtn.addEventListener("click", (e) => {
  e.preventDefault()
  closeMergeModal()
})
closeMergeBtn.addEventListener("click", (e) => {
  e.preventDefault()
  closeMergeModal()
})
